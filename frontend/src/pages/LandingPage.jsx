  ...
  return (
    <div className="min-h-screen bg-white selection:bg-emerald-100 selection:text-emerald-900">
      ...
      <section className="relative pt-24 pb-20 lg:pt-32 lg:pb-40 overflow-hidden bg-white">
        <div className="max-w-7xl mx-auto px-6 sm:px-8 relative z-10">
            <div className="flex flex-col lg:flex-row items-center gap-16 lg:gap-24">
                ...
                >
                    <motion.div variants={itemVariants} className="inline-flex items-center gap-2 py-1.5 px-4 rounded-lg bg-emerald-50 border border-emerald-100 text-emerald-600 text-[10px] font-bold uppercase tracking-[2px] mb-8">
                    ...
                    <motion.h1 variants={itemVariants} className="text-4xl sm:text-5xl lg:text-7xl font-bold text-slate-900 mb-8 leading-[1.05] tracking-tight">
                        Best Prices for <br />
                        <span className="text-emerald-500 font-medium">Your Scrap.</span>
                    </motion.h1>
                    
                    <motion.p variants={itemVariants} className="text-base md:text-lg text-slate-600 mb-10 leading-relaxed max-w-lg font-medium">
                    ...
                    <motion.div variants={itemVariants} className="flex flex-col sm:flex-row gap-4">
                        <Link to="/register" className="group bg-emerald-500 text-white px-8 py-4 rounded-xl font-bold text-[11px] uppercase tracking-widest hover:bg-emerald-400 transition-all flex items-center justify-center gap-2.5 shadow-lg shadow-emerald-200">
                            Sell Now <ArrowRight className="h-4 w-4 group-hover:translate-x-1 transition-transform" />
                        </Link>
                        <Link to="/rates" className="bg-white text-emerald-500 px-8 py-4 rounded-xl font-bold text-[11px] uppercase tracking-widest hover:bg-emerald-50 transition-all border border-emerald-100 text-center">
                            Check Prices
                        </Link>
                    </motion.div>
                </motion.div>
                ...
                >
                    <div className="relative rounded-xl overflow-hidden shadow-[0_32px_64px_-16px_rgba(16,185,129,0.2)] border border-emerald-100 bg-white aspect-video lg:aspect-[4/3] group">
                        ...
                        />
                        <div className="absolute inset-0 bg-gradient-to-t from-emerald-500/30 to-transparent pointer-events-none" />
                    </div>
                </motion.div>
            </div>
        </div>
          ...
          <div className="max-w-7xl mx-auto px-6 sm:px-8">
              <div className="flex flex-col lg:flex-row justify-between items-start lg:items-end mb-20 gap-8">
                  <div className="max-w-2xl">
                    <div className="flex items-center gap-2 mb-4">
                        ...
                        <span className="text-[10px] font-bold uppercase tracking-[2px] text-emerald-500">How It Works</span>
                    </div>
                    <h2 className="text-3xl md:text-4xl font-bold text-slate-900 tracking-tight">Recycling Made Easy</h2>
                    <p className="text-slate-600 font-medium mt-4 text-sm leading-relaxed">A simple and transparent way to manage waste, track your impact, and earn rewards for a cleaner planet.</p>
                  </div>
                  <Link to="/register" className="text-emerald-500 font-bold text-[10px] uppercase tracking-widest flex items-center gap-2 group border-b-2 border-emerald-200 pb-1 hover:border-emerald-400 transition-colors">
              ...
              <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                  {[
                      ...
                      <div key={i} className="bg-white p-10 rounded-xl border border-emerald-100 shadow-sm hover:border-emerald-300 transition-all group">
                          <div className="w-12 h-12 bg-emerald-50 rounded-lg border border-slate-100 flex items-center justify-center mb-8 group-hover:bg-emerald-500 group-hover:text-white transition-all">
      ...
      <section id="benefits" className="py-24 bg-white border-b border-slate-50">
          <div className="max-w-7xl mx-auto px-6 sm:px-8">
              <div className="text-center mb-16">
                  <span className="text-[10px] font-bold uppercase tracking-[2px] text-emerald-500 block mb-3">Why Choose Us</span>
                  <h2 className="text-3xl md:text-4xl font-bold text-slate-900 tracking-tight">One Platform, Two Ecosystems</h2>
              </div>
              ...
              <div className="grid md:grid-cols-2 gap-8 lg:gap-16">
                  ...
                  <div className="bg-emerald-50/50 rounded-3xl p-10 border border-emerald-100 flex flex-col">
                      <div className="mb-8">
                          <h3 className="text-2xl font-bold text-slate-900 mb-2">For Citizens</h3>
                          <p className="text-slate-600 font-medium text-sm">Household generators & small businesses</p>
                      </div>
                      ...
                      <Link to="/register" className="w-full py-4 rounded-xl bg-white border border-emerald-200 text-emerald-600 font-bold text-xs uppercase tracking-widest hover:bg-emerald-500 hover:text-white transition-all text-center shadow-sm">
                          Start Recycling
                      </Link>
                  </div>

                  {/* Collector Benefit Card */}
                  <div className="bg-emerald-500 rounded-3xl p-10 text-white flex flex-col relative overflow-hidden">
                      ...
                      <ul className="space-y-6 mb-10 flex-1 relative z-10">
                           {[
                               ...
                               <li key={i} className="flex items-start gap-3">
                                   <div className="mt-1 min-w-5 h-5 rounded-full bg-emerald-400 flex items-center justify-center">
                      ...
                      <Link to="/register?role=collector" className="relative z-10 w-full py-4 rounded-xl bg-emerald-400 text-white font-bold text-xs uppercase tracking-widest hover:bg-emerald-300 transition-all text-center shadow-lg shadow-emerald-500/30">
                          Join as Collector
                      </Link>
                  </div>
              </div>
      ...
      <section id="market-rates" className="py-32 bg-white">
        <div className="max-w-7xl mx-auto px-6 sm:px-8">
             <div className="bg-emerald-500 rounded-xl p-10 md:p-20 relative overflow-hidden text-left shadow-2xl">
                  {/* Decorative Elements */}
                  ...
                  <div className="relative z-10 flex flex-col lg:flex-row items-center justify-between gap-16 md:gap-24">
                      <div className="lg:w-1/2">
                          ...
                          <Link to="/rates" className="bg-white text-emerald-600 px-8 py-4 rounded-lg font-bold text-[11px] uppercase tracking-widest hover:bg-emerald-50 transition shadow-lg inline-flex items-center gap-2">
                      ...
                      <div className="lg:w-1/2 w-full grid grid-cols-1 sm:grid-cols-2 gap-4">
                          {rates.length > 0 ? rates.map((rate) => (
                            <div key={rate._id} className="bg-emerald-400/40 backdrop-blur-md p-6 rounded-lg border border-emerald-300/50 hover:bg-emerald-400/60 transition-all group">
                                ...
                                <div className="flex items-baseline gap-1.5 mb-1">
                                    ...
                                    <span className="text-[10px] font-bold text-emerald-100/80 uppercase">/{rate.unit}</span>
                                </div>
                                <div className="text-[10px] font-bold text-slate-400 uppercase tracking-tighter truncate">{rate.name}</div>
                            </div>
                          )) : (
                              <div className="col-span-2 text-center py-10">
                                  <div className="text-[10px] font-bold text-emerald-100/80 uppercase tracking-widest animate-pulse">Synchronizing Global Feed...</div>
                              </div>
                          )}
                      </div>
                  </div>
      ...
      <section className="py-40 bg-emerald-50/50 border-t border-emerald-100 relative overflow-hidden">
         <div className="max-w-7xl mx-auto px-6 sm:px-8 text-center relative z-10">
            <div className="max-w-3xl mx-auto">
                <h2 className="text-5xl font-bold text-slate-900 mb-8 tracking-tight">Start Selling Today.</h2>
                <p className="text-base text-slate-600 mb-12 font-medium">Join 12,000+ smart citizens making money from their waste.</p>
                <div className="flex flex-col sm:flex-row justify-center gap-4">
                    <Link to="/register" className="bg-emerald-500 text-white px-10 py-5 rounded-xl font-bold text-[11px] uppercase tracking-[3px] hover:bg-emerald-400 transition shadow-lg shadow-emerald-200">
                        Register Now
                    </Link>
                </div>
            </div>
      ...
      <footer className="bg-white py-24 border-t border-emerald-50">
          <div className="max-w-7xl mx-auto px-6 sm:px-8">
              <div className="flex flex-col md:flex-row justify-between items-start gap-16">
                  <div className="max-w-sm">
                      <div className="flex items-center gap-2 mb-6">
                        ...
                        <span className="text-xl font-semibold text-slate-900 tracking-tight">CleanLink</span>
                      </div>
                  ...
                  <div className="grid grid-cols-2 md:grid-cols-3 gap-16">
                      <div>
                          <h4 className="text-[10px] font-bold text-slate-900 uppercase tracking-widest mb-8">Platform</h4>
                          <ul className="space-y-4 text-xs font-semibold text-slate-600">
                              <li><a href="#" className="hover:text-slate-900">For Individuals</a></li>
                              <li><a href="#" className="hover:text-slate-900">For Collectors</a></li>
                              <li><a href="#" className="hover:text-slate-900">Live Prices</a></li>
                          </ul>
                      </div>
                      <div>
                          <h4 className="text-[10px] font-bold text-slate-900 uppercase tracking-widest mb-8">Company</h4>
                          <ul className="space-y-4 text-xs font-semibold text-slate-600">
              ...
              <div className="border-t border-slate-200 mt-16 pt-8 flex flex-col md:flex-row justify-between items-center text-xs text-slate-500">
                  <p>© 2024 CleanLink. All rights reserved.</p>
